...
def make_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    if checkpoint is not None:
        ...
        #print(checkpoint['model']['encoder.embeddings.emb_luts.0.weight'])
        #checkpoint['model'].pop('encoder.embeddings.emb_luts.0.weight')
        #checkpoint['model'].pop('decoder.embeddings.emb_luts.0.weight')
